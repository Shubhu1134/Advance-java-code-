package com.info.SpringMvctest.config;
...
@ComponentScan(basePackages = {"com.info.SpringMvctest.service"})
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {"com.info.SpringMvctest.repo"})
@Configuration
public class JPAConfig {
  ...
  public DriverManagerDataSource getDataSource() {
	  ...
	  dataSource.setUrl("jdbc:mysql://localhost:3306/springmvcdb?createDatabaseIfNotExist=true");
  ...
  public LocalContainerEntityManagerFactoryBean getFactory(DriverManagerDataSource dataSource) {
     ...
     factory.setPackagesToScan("com.info.SpringMvctest.entity");
