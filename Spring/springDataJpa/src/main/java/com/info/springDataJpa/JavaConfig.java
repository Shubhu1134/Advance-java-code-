...
@EnableJpaRepositories(basePackages = "com.info.springDataJpa.repo")
@EnableTransactionManagement
@Configuration
@ComponentScan(basePackages = {"com.info.springDataJpa.service"})
public class JavaConfig {
	...
	public LocalContainerEntityManagerFactoryBean getEntityManagerFactory(DriverManagerDataSource dataSource) {
	   ...
	   factory.setPackagesToScan("com.info.springDataJpa.entity");
